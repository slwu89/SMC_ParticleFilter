...
depend_seirs <- matrix(c(F,T,T,T,T,T,T,T,T, #S to E
...
library(microbenchmark)
  microbenchmark(
    gillespie_first(theta_seirs,init_state_seirs,trans_seirs,20,FALSE),
    gillespie_direct(theta_seirs,init_state_seirs,trans_seirs,20,FALSE),
    times=5e3)
*/
